...
class Aplicacion():
    def __init__(self):
        ...
        print(self.classifier.X_train.shape)
        self.root = Tk()
        ...
        self.lbl1= Label(self.root,text=" Análisis Sentimental de tweets respecto\na la modalidad virtual",font=("Helvetica",30),fg="white",bg="brown")
