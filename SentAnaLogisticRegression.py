...
class Classifier:
    ...
    def __init__(self):
        ...
        tweets_train, tweets_test, y_train, y_test = train_test_split(tweets, y, test_size=0.10, random_state=0)
        self.vectorizer=CountVectorizer( token_pattern=r'\b\w+\b', min_df=4)  #ngram_range=(1, 2), stop_words=stop
